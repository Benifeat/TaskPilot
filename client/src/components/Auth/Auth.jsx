    ...
    return <>
        <div className="fixed h-screen w-[100%] flex justify-center items-center bg-neutral-700/30 p-0 z-40">
            <Toast.Provider swipeDirection="right">
                <Toast.Root type="background" className={`ToastRoot ${!valid.email && forgotPassword ? "bg-green-500" : "bg-red-600"} text-white flex justify-between items-start `} open={open} onOpenChange={setOpen}>
